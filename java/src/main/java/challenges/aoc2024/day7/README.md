...
Operators are always evaluated **_left-to-right_**, **_not_** according to precedence rules. Furthermore, numbers in the equations cannot be rearranged. Glancing into the jungle, you can see elephants holding two different types of operators: **_add_** (`+`) and **_multiply_** (`*`).
